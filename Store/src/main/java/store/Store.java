...
public class Store {
    ...
    public List<store.Product> getProducts() {
    ...
    public void addProduct(store.Product product) {
        if (product == null) {
    ...
    public store.Product getTheMostExpensiveProduct() {
        store.Product product = this
                .products
                .stream()
